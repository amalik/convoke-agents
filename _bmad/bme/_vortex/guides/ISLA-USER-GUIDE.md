...
**Claude Code:**
```
Read the file at _bmad/bme/_vortex/agents/discovery-empathy-expert/SKILL.md
```

**Terminal:**
```bash
cat _bmad/bme/_vortex/agents/discovery-empathy-expert/SKILL.md
```

**Claude.ai:** Copy the contents of `_bmad/bme/_vortex/agents/discovery-empathy-expert/SKILL.md` and paste into the chat.
