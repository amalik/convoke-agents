...
**Claude Code:**
```
Read the file at _bmad/bme/_vortex/agents/lean-experiments-specialist/SKILL.md
```

**Terminal:**
```bash
cat _bmad/bme/_vortex/agents/lean-experiments-specialist/SKILL.md
```

**Claude.ai:** Copy the contents of `_bmad/bme/_vortex/agents/lean-experiments-specialist/SKILL.md` and paste into the chat.
