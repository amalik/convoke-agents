...
reserved) are declared once in [`_bmad/bme/_config/name-registry.csv`](https://github.com/amalik/convoke-agents/blob/main/_bmad/bme/_config/name-registry.csv).
