...
**Namespace decision:** New user-facing doc at `docs/migration/3.x-to-4.0.md` (creates new `docs/migration/` directory). Linked from `scripts/convoke-update.js` CLI output + `CHANGELOG.md`. Not a `_bmad/bme/` skill; Covenant checklist does NOT apply.
...
**Implementation:** modify [`scripts/convoke-update.js`](../../scripts/convoke-update.js) to print this line in the breaking-change banner path. Single-line addition; path is a relative-from-repo-root string.
...
- [ ] **Task 3: Wire the convoke-update CLI reference** (AC4)
  - [ ] 3.1 Read [`scripts/convoke-update.js`](../../scripts/convoke-update.js) — find the breaking-change banner path (grep for `breaking` or `displays breaking changes warning`).
...
- **Modified:** `scripts/convoke-update.js` (one-line addition to breaking-change output)
...
_New files:_
- [`docs/migration/3.x-to-4.0.md`](../../docs/migration/3.x-to-4.0.md) — 55 LOC. Finalized migration guide for 3.x → 4.0 users.

_Modified files:_
- [`scripts/update/convoke-update.js`](../../scripts/update/convoke-update.js) — +1 line: guide link in breaking-changes CLI output.
- [`tests/unit/convoke-update.test.js`](../../tests/unit/convoke-update.test.js) — +5 lines: guide-link assertion in v1.7.x breaking-change test.
- [`_bmad-output/planning-artifacts/convoke-migration-guide-3.x-to-4.0-draft.md`](../planning-artifacts/convoke-migration-guide-3.x-to-4.0-draft.md) — +2 lines: pointer to final.
- [`CHANGELOG.md`](../../CHANGELOG.md) — +3 lines: HTML-comment marker for Story 5B.1 handoff.
