...
|----|-------------|---|---|---|---|-------|-----------|--------|--------------|
| D9 | Create `docs/README.md` as docs index with Covenant callout — makes AC #3's 4th discovery path real (currently `docs/` has 6 contributor files with no Covenant orientation) | 5 | 1 | 90% | 0.5 | 9.0 | convoke | Backlog | deferred-from: oc-1-5 Round 1 |
