...
**Status:** Draft (Pass 1 — process definition + empty structure)
...
Example: `B, P✓, A` = has Brief, validated PRD, and Architecture. Missing IR and Epics.
...
> **Status:** Empty structure (Pass 1). Items will be populated in Pass 2 (retroactive review of all existing backlog items).
...
Items qualified as not needing the full initiative pipeline.
...
Items removed from active backlog. Nothing disappears without a receipt.

| ID | Original Description | Disposition | Reference | Date |
|----|---------------------|-------------|-----------|------|
| | | Absorbed / Archived / Superseded | Link to epic or reason | |

---

## Appendix: Item Details

> Full descriptions for items whose table row is a one-liner. Linked by ID.
