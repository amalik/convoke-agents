...
|----|-------------|---|---|---|---|-------|-----------|--------|--------------|
| D8 | Add `_bmad/bme/config.yaml` to bme/README — either extend Submodules table or add a sibling "Files" note; currently contributor orientation misses the config file | 3 | 0.5 | 100% | 0.2 | 7.5 | convoke | Backlog | deferred-from: oc-1-5 Round 1 |
...
| D9 | `docs/README.md` created as docs index with Covenant pointer as the featured callout — AC #3's 4th discovery path now real. Contents table enumerates the 6 existing contributor-facing docs; cross-refs to repo README, bme README, and `project-context.md`. `docs/` is no longer a Covenant-orientation dead zone. | 2026-04-19 | 9.0 | convoke |
