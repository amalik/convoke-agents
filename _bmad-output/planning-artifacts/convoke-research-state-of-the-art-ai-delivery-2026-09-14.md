...
Desk research feeding the BMAD Method + Convoke client whitepaper. Draft for review. All sources were accessed on 14–15 September 2026. Nothing in this document is drawn from the products' own claims except where it is explicitly labelled as a self-description.

---

## 1. Executive summary

**AI coding help is now mainstream. Proof of business benefit is not.** In a vendor survey of more than 15,000 professional developers, 90% said they used AI coding agents at work at least weekly (JetBrains, May–July 2026). The most rigorous studies disagree with each other, though. A 2025 randomised trial found experienced developers were 19% *slower* with AI. Company field trials found 26% more tasks completed. The 2026 follow-up to the first trial could not measure the effect reliably, because too many developers refused to work without AI.

**AI increases output and strains quality and stability.** Google's DORA research linked AI adoption to less stable software delivery in both 2024 and 2025. Vendor data points the same way: more code, longer reviews, more incidents. DORA's central conclusion is that AI *amplifies* whatever an organisation already is.

**Structured AI delivery methods are a crowded, young category.** BMAD Method is one of about six open-source frameworks that wrap AI coding tools in a defined process. Others include GitHub Spec Kit, OpenSpec, AWS AI-DLC, Superpowers and GSD. We found no independent evidence that any of them improves business outcomes. Thoughtworks rates the approach "Assess" (worth exploring, not yet a safe bet). It singles out BMAD as heavier and more rigid than lighter alternatives.
...
**In product discovery, AI helps when you work with real customers and is risky when it replaces them.** The evidence supports using AI to run and analyse research with real people. AI-simulated "synthetic users" are contested. A 2026 *Nature* study found they predict average survey-experiment effects well. Other peer-reviewed work finds they flatten differences between groups and tell teams what they want to hear.

**In operations, AI assists but cannot yet run things on its own.** On public benchmarks, AI agents solved about one realistic reliability incident in seven, or fewer. The industry standard for monitoring AI agents is not yet stable.
...
**Where BMAD sits.** BMAD Method is a method-layer framework delivered as skills. Its current release is v6.12.0 (4 September 2026). The first stable v6, 6.0.4, came out on 1 March 2026. There have been 19 stable 6.x releases since, and v6.12.0 alone carries several breaking changes.
...
The only structured comparison we found is a single-author arXiv preprint (June 2026). It rated BMAD strong on roles, specification and context and weaker on portability, and concluded that its "effectiveness depends on usage discipline and on independent empirical evaluation". The author also noted that no framework "strongly covers all six dimensions".
...
| First stable v6 (6.0.4) was published on 2026-03-01; 19 stable 6.x versions have been published since | npm registry, `npm view bmad-method time` | read 2026-09-14 | Verified |
...
| A practitioner comparison found "BMAD Full" took 6 days and about $200 in AI usage, against 1–2 days for other tools (n=1; original not located) | Ry Walker Research, "BMAD Method", https://rywalker.com/research/bmad-method | Apr 2026 | Reported |
...
| Review of 12 peer-reviewed papers: discrepancies "vastly outnumbered successes"; reduced variability; "tendency for models to exaggerate effects" | MeasuringU (Lewis, Sauro), "A Review of Experiments with Synthetic Users", https://measuringu.com/review-of-experiments-with-synthetic-users/ | 2026-04-14 | Verified |
...
| Agents resolved 13.8% of SRE scenarios, 25.2% of CISO scenarios and 0% of FinOps scenarios | Jha et al. (IBM, UIUC), "ITBench", arXiv 2502.05352, https://arxiv.org/abs/2502.05352 | 2025-02-07 | Verified |
...
| AI-co-authored PRs contained about 1.7x more issues than human PRs (470 open-source PRs) | CodeRabbit, "State of AI vs Human Code Generation" (newsroom), https://www.coderabbit.ai/newsroom/state-of-ai-vs-human-code-generation-report | Dec 2025 | Reported |
...
Harmonised standards that would give a presumption of conformity are late. Reports place the quality-management standard prEN 18286 at formal vote in mid-2026.

**Relevant obligations.** The following apply to *high-risk* systems:
- **Article 14** requires that overseers can understand the system's limits, "remain aware of … automation bias", override its output, and stop it.
...
- **Article 26(6)** requires keeping automatically generated logs for at least six months.

AI coding and discovery assistants are generally not named high-risk categories. What clients *build* with them may be.
...
3. **Records and logs.** Artifacts written by agents are not automatic, tamper-evident operational logs of the kind Art. 26(6) contemplates for high-risk systems.
4. **Organisation-level management.** ISO/IEC 42001 and NIST GOVERN expect policies, inventories, impact assessment and supplier oversight across all AI use, not per-interaction etiquette.
...
7. **Verification of the Covenant itself.** The Covenant reports that 46 of 56 audit cells pass (82%). It also discloses that the audit used a single LLM reviewer, was mostly static, and was run inside the project.
